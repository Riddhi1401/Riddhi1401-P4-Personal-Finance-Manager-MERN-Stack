...
function Header()
{
  ...
  const handleShowLogin = () =>{
    ...
    return (
        <>
            <div style={{borderRadius:'5px', backgroundColor:'white',height:'auto',display:'flex',justifyContent:'space-between', marginTop:'auto', color:'black', width: 'auto',marginLeft:'auto'}}>
